...
Creates 5 files in `src/shared/pipes/` and `src/shared/decorators/`.

---

## File 1: `src/shared/pipes/custom-zod-validation.exception.ts`
...
## File 2: `src/shared/decorators/zod-schema.decorator.ts`
...
## File 4: `src/shared/pipes/index.ts`
...
## File 5: `src/shared/decorators/index.ts`
...
**Global mode** (registered in `main.ts`, auto-discovers schema from decorator):
```ts
